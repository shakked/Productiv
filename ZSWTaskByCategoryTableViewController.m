...
@interface ZSWTaskByCategoryTableViewController () <UIGestureRecognizerDelegate>
...
@implementation ZSWTaskByCategoryTableViewController
...
- (void)viewDidLoad
{
    ...
    //pull to refresh
    __weak ZSWTaskByCategoryTableViewController *weakSelf = self;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //navigation
    NSString *category = [self.category valueForKey:@"name"];
...
{
    NSArray *categoryTasks = [[NSArray alloc] init];
    if (self.segIndex == 0) {
        categoryTasks = [[ZSWTaskStore sharedStore] tasksWithCategory:self.category];
    } else if (self.segIndex == 1) {
        categoryTasks = [[ZSWTaskStore sharedStore] tasksWithCategory:self.category complete:YES];
    } else if (self.segIndex == 2) {
        categoryTasks = [[ZSWTaskStore sharedStore] tasksWithCategory:self.category complete:NO];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        ZSWTask *task = categoryTasks[indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        dvc.task = categoryTasks[indexPath.row];
